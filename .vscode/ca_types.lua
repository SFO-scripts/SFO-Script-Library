...
--# type global LISTENER_CONDITION = 
--# boolean | (function(context: WHATEVER?) --> boolean)
...
--# assume CA_MODEL.campaign_name: method(name: string) --> boolean
...
--#     listenerName: string,
--#     eventName: string,
--#     conditionFunc: LISTENER_CONDITION,
